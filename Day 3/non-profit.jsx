...
import nonprofitpageImage from '../../assets/images/non-profit.jpg'; // Import the image for the homepage
...
const Weddings=()=> {
    return (
        ...
        <h1 style={{fontFamily:"Times New Roman",fontWeight:"100"}}>Non-Profit</h1>
        <div className="home">
            <div className="weddingpage-image">
                <img src={nonprofitpageImage} alt="Homepage" />
            </div>
        </div>
